...
export class WakuNode {
    ...
    createDecoder(params) {
        ...
        log.info(`Creating Decoder with input:${JSON.stringify(params.shardInfo)}, determined:${JSON.stringify(singleShardInfo)}, expected:${JSON.stringify(this.networkConfig)}.`);
    ...
    createEncoder(params) {
        const singleShardInfo = decoderParamsToShardInfo(params, this.networkConfig);
        log.info(`Creating Encoder with input:${JSON.stringify(params.shardInfo)}, determined:${JSON.stringify(singleShardInfo)}, expected:${JSON.stringify(this.networkConfig)}.`);
        if (!isShardCompatible(singleShardInfo, this.networkConfig)) {
