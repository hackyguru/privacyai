...
export type IFilter = {
     ...
     * }
     */
    subscribe<T extends IDecodedMessage>(decoders: IDecoder<T> | IDecoder<T>[], callback: Callback<T>): Promise<boolean>;
    /**
     ...
     * }
     */
    unsubscribe<T extends IDecodedMessage>(decoders: IDecoder<T> | IDecoder<T>[]): Promise<boolean>;
    /**
